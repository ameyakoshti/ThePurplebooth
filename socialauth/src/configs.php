...
$conf_main['base_path_codenameDS'] = 'http://localhost:8888/codenameDS/index.php';
...
//Callback url for twitter. e.g. http://freelanceduty.com/codecanyon/SocialAuth/v3/callback.php?type=twitter
$conf_twitter['oauth_callback'] = 'http://localhost:8888/codenameDS/socialauth/callback.php?type=twitter';
...
//Callback url for facebook. e.g. http://freelanceduty.com/codecanyon/SocialAuth/v3/callback.php?type=facebook 
$conf_facebook['redirect_uri'] = 'http://localhost:8888/codenameDS/socialauth/callback.php?type=facebook';
...
$conf_linkedin['linkedin_access'] = 'vhrooi13g941';
$conf_linkedin['linkedin_secret'] = 'NiYyOuhiB5E3h82X';
//Callback url for linkedin. e.g. http://freelanceduty.com/codecanyon/SocialAuth/v3/callback.php?type=linkedin
$conf_linkedin['callback_url'] = 'http://localhost:8888/codenameDS/socialauth/callback.php?type=linkedin';
$conf_linkedin['base_url'] = $conf_main['base_path'];

/** Google configurations */

//Callback url for google. e.g. http://freelanceduty.com/codecanyon/SocialAuth/v3/callback.php?type=google
$conf_google['return_url'] = 'http://localhost:8888/codenameDS/socialauth/callback.php?type=google';

/** Yahoo configurations */

//Yahoo credentials

//Callback url for yahoo. e.g. http://freelanceduty.com/codecanyon/SocialAuth/v3/callback.php?type=yahoo
$conf_yahoo['return_url'] = 'http://localhost:8888/codenameDS/socialauth/callback.php?type=yahoo';
